#!/usr/bin/env python3
"""
This module is a test for access_nested_map function
"""
import unittest
import requests
...
class TestAccessNestedMap(unittest.TestCase):
    ...
    def test_access_nested_map(self, nested_map: Mapping,
        ...
        """
        This function tests the access_nested_map method.
...
class TestGetJson(unittest.TestCase):
    ...
    def test_get_json(self, test_url, test_payload, mock_requests_get):
        """
        This is the first test to evaluate the get_json method
        and ensure it returns the expected output.
...
class TestMemoize(unittest.TestCase):
    """
    This class tests the memoization decorator, memoize
    """

    def test_memoize(self):
        """
        Function to test that utils.memoize decorator works as intended
        """
        class TestClass:
        ...
        # Patching the method to be memoized
        with patch.object(TestClass, 'a_method') as mock_object:
            ...
            test.a_property()
            # Ensure the method was called only once
